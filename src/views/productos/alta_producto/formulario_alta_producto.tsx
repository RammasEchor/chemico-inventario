    ...
    <Formik
      ...
      validationSchema={Yup.object({
        ...
        descripcion: Yup.string().required(
          appendFieldRequiredSpanish("Descripción")
        ),
        ...
        precio: Yup.string().required(
          appendFieldRequiredSpanish("Precio Unitario")
        ),
        ...
        ubicacion: Yup.string().required(
          appendFieldRequiredSpanish("Ubicación")
        ),
        stock: Yup.string().required(
          appendFieldRequiredSpanish("Cantidad Inicial")
        ),
              ...
              <section className="modal-card-body">
                <FileForm
                  ...
                  saveFilename={(filename: string) =>
                    formik.setFieldValue("nomImg", filename)
                  }
                />
              </section>
            </div>
